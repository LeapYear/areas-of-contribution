...
<td valign="top"><ul>
  <li>Surfaces and discusses various factors (e.g. maintainability, extensibility, security) when approaching a technical decision, with support from colleagues to make the final decision.</li>
